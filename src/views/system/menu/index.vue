...
<template>
  <div class="default-main page">
    ...
    >
      ...
      <template #isFrameLabel="{ backData }">
        <span>
          <el-tooltip
      ...
      <template #componentLabel="{ backData }">
        <span>
          <el-tooltip
      ...
      <template #queryLabel="{ backData }">
        <span>
          <el-tooltip
            content='访问路由的默认传递参数，如：{"id": 1}'
            placement="top"
          >
            <el-icon><question-filled /></el-icon>
          </el-tooltip>
      ...
      <template #isCacheLabel="{ backData }">
        <span>
          <el-tooltip
      ...
      <template #visibleLabel="{ backData }">
        <span>
          <el-tooltip
